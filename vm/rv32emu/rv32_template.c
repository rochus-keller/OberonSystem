 ...
 */
/* RV32_MMIO_CALLBACKS keeps the io callbacks in non-SYSTEM mode, which a host
 * needs when part of the address space are devices and not RAM */
#if !RV32_HAS(SYSTEM) && !defined(RV32_MMIO_CALLBACKS)
